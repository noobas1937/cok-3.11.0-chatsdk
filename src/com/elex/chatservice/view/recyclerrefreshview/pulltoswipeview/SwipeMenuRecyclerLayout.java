...
public class SwipeMenuRecyclerLayout extends FrameLayout {
	...
	private int mSwipeDirection = SwipeMenuRecyclerListView.DIRECTION_LEFT;

	private View mContentView;
	private SwipeMenuRecyclerView mMenuView;
	private int mDownX;
	...
	public SwipeMenuRecyclerLayout(View contentView, SwipeMenuRecyclerView menuView) {
	...
	private SwipeMenuRecyclerLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	private SwipeMenuRecyclerLayout(Context context) {
		super(context);
	}
	...
	public void setVisibleMenu(int[] type)
	{
		mMenuView.setVisibleMenu(type);
	}
	...
	public void setIsOpen(boolean isOpen) {
		state = isOpen ? STATE_OPEN : STATE_CLOSE;
	}
	...
	public void swipe(int dis) {
		...
		if (mSwipeDirection == SwipeMenuRecyclerListView.DIRECTION_LEFT) {
	...
	public SwipeMenuRecyclerView getMenuView() {
		return mMenuView;
	}
