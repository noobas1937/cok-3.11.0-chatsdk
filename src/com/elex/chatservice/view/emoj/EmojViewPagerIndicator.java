...
@SuppressLint("NewApi")
public class EmojViewPagerIndicator extends LinearLayout{
    ...
    public EmojViewPagerIndicator(Context context, AttributeSet attrs, int defStyle) {
        this(context, null);
    }

    public EmojViewPagerIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public EmojViewPagerIndicator(Context context) {
        this(context,null);
    }
    
    private void init(Context context, AttributeSet attrs){
        this.context = context;
        dotHeight = ScaleUtil.dip2px(context, dotHeight);
        selectedBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.dot_emoj_selected);
        unselectedBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.dot_emoj_unselected);
        setGravity(Gravity.CENTER_HORIZONTAL);
    }
    
    public void clearAllDotViews()
    {
    	removeAllViews();
    }
