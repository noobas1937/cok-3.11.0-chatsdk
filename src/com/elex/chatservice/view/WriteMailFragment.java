	...
	public void onViewCreated(View view, Bundle savedInstanceState)
	{
		...
		addPeopleButton.setOnClickListener(new View.OnClickListener()
		{
			...
			public void onClick(View view)
			{
				...
				LogUtil.trackAction("add_mail_receiver");
			}
		});
		...
		sendMailButton.setOnClickListener(new View.OnClickListener()
		{
			...
			{
				sendMail();
				LogUtil.trackAction("click_send_mail");
			}
		});
	...
	private void sendMail()
	{
		...
		else
		{
			...
			if(SwitchUtils.customWebsocketEnable){
				WebSocketManager.getInstance().roomGroupCreate(roomName,memberUids);
			}else {
				JniController.getInstance().excuteJNIVoidMethod("createChatRoom",
						new Object[] { memberNames, memberUids, tempRoomName, contentEditText.getText().toString(),Integer.valueOf(isNotDefaultName) });
			}
		}
