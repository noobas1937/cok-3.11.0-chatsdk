	...
	protected void onLayout(boolean changed, int left, int top, int right, int bottom)
	{
		...
		while (true)
		{
			if (index >= childrenCount)
			{
				...
				if (topView != null)
				{
//					System.out.println("pulldown onLayout 222222");
	...
	{
//		System.out.println("startTopScroll");
...
//				System.out.println("startScroll 2");
				...
				if (!isProgressBarShowed)
				{
					...
					{
//						System.out.println("startScroll 3");
						this.isScrollToDownStoped = true;
					}
					else
					{
			...
			{
//				System.out.println("startScroll 4");
				this.mScroller.startScroll(0, getScrollY(), 0, -getScrollY() + this.topViewHeight, 200);
			}
			postInvalidate();
		}
		...
		{
//			System.out.println("startScroll 5");
			if (!this.isBottomWithOutScroll)
			{
//				System.out.println("startScroll 6");
...
//				this.isScrollStoped = true;
			...
			{
//				System.out.println("startScroll 7");
				this.mScroller.startScroll(0, getScrollY(), 0, this.bottomViewHeight - getScrollY(), 200);
			}
			postInvalidate();
		}
	...
	{
//		System.out.println("pulldown dispatchTouchEvent 1");
		boolean bool = true;
		if (this.isFristTouch)
		{
//			System.out.println("pulldown dispatchTouchEvent 2");
			...
			if (this.topViewInitializeVisibility == View.VISIBLE)
			{
				if (!this.isCloseTopAllowRefersh)
				{
//					System.out.println("pulldown dispatchTouchEvent 222222");
					this.topView.setVisibility(View.VISIBLE);
				}
				else
				{
...
//							System.out.println("pulldown dispatchTouchEvent 3 bool:"+bool);
						}
						catch (Exception e)
						{
							LogUtil.printException(e);
...
//						paramMotionEvent.setAction(MotionEvent.ACTION_CANCEL);
						...
						{
							bool = super.dispatchTouchEvent(paramMotionEvent);
//							System.out.println("pulldown dispatchTouchEvent 4 bool:"+bool);
						}
						catch (Exception e)
						{
							LogUtil.printException(e);
				...
				{
//					System.out.println("pulldown dispatchTouchEvent 5");
					startScroll();
				}
			}
			else
...
//				inputManager.hideSoftInputFromWindow(getWindowToken(), 0);
				...
				{
					bool = super.dispatchTouchEvent(paramMotionEvent);
//					System.out.println("pulldown dispatchTouchEvent 6 bool:"+bool);
				}
				catch (Exception e)
				{
					LogUtil.printException(e);
	...
	{
		super.computeScroll();
//		System.out.println("computeScroll 0");
		if (!this.mScroller.computeScrollOffset())
		{
//			System.out.println("computeScroll 1");
		...
		{
//			System.out.println("computeScroll 2");
			scrollTo(this.mScroller.getCurrX(), this.mScroller.getCurrY());
			postInvalidate();
		}
		isFristTouch = this.mScroller.isFinished();
//		System.out.println("isFristTouch:"+isFristTouch);
	}
