...
public class SlidingUpPanelLayout extends ViewGroup {
     ...
     */
    private static final float DEFAULT_ANCHOR_POINT = 0f; // In relative %
    ...
    private View mScrollableViewParent;
    ...
    private List<PanelSlideListener> mPanelSlideListeners = new ArrayList<SlidingUpPanelLayout.PanelSlideListener>();
    ...
    public SlidingUpPanelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mPanelHeight = DEFAULT_PANEL_HEIGHT;
        mShadowHeight = DEFAULT_SHADOW_HEIGHT;
        mParallaxOffset = DEFAULT_PARALLAX_OFFSET;

        mMinFlingVelocity = DEFAULT_MIN_FLING_VELOCITY;
        mCoveredFadeColor = DEFAULT_FADE_COLOR;

//        mDragViewResId = R.id.dragView;
//        mScrollableViewResId = R.id.alliance_sys_msg_listview;

        mOverlayContent = true;
        mClipPanel = DEFAULT_CLIP_PANEL_FLAG;
    ...
    public void setDragViewId(int resId)
    {
    	mDragViewResId = resId;
    }
    
    public void setScrollableViewResId(int resId)
    {
    	mScrollableViewResId = resId;
    }
    ...
    public void setScrollableViewParent(View parent)
    {
    	mScrollableViewParent = parent;
    }
...
//            System.out.println("dispatchTouchEvent 1");
            ...
            if (!isViewUnder(mScrollableViewParent, (int) mInitialMotionX, (int) mInitialMotionY)) {
            	boolean bool = super.dispatchTouchEvent(ev);
//            	System.out.println("dispatchTouchEvent 2 bool:"+bool);
                return bool;
            }
...
//                    System.out.println("dispatchTouchEvent 5");
                }
...
//            	System.out.println("dispatchTouchEvent 6");
                if (mSlideOffset < 1.0f) {
                    mIsScrollableViewHandlingTouch = false;
//                    System.out.println("dispatchTouchEvent 7");
                    return this.onTouchEvent(ev);
                ...
                if (!mIsScrollableViewHandlingTouch && mDragHelper.isDragging()) {
                    mDragHelper.cancel();
                    ev.setAction(MotionEvent.ACTION_DOWN);
//                    System.out.println("dispatchTouchEvent 8");
                }

                mIsScrollableViewHandlingTouch = true;
                boolean bool = super.dispatchTouchEvent(ev);
//                System.out.println("dispatchTouchEvent 9 bool:"+bool);
                return bool;
            }
...
//        System.out.println("dispatchTouchEvent 10");
    ...
    public void setPanelState(PanelState state) {
        ...
        {
        	System.out.println("state == PanelState.HIDDEN 1");
        }
        if (mFirstLayout) {
            setPanelStateInternal(state);
        } else {
            if (mSlideState == PanelState.HIDDEN) {
            	System.out.println("mSlideState == PanelState.HIDDEN");
            ...
            switch (state) {
                ...
                case EXPANDED:
                    ...
                    break;
                case HIDDEN:
                	System.out.println("state == PanelState.HIDDEN");
                    int newTop = computePanelTopPosition(0.0f) + (mIsSlidingUp ? +mPanelHeight : -mPanelHeight);
...
//            	System.out.println("onViewReleased 1");
                ...
                LogUtil.trackAction("alliance_sys_tip_down");
//                System.out.println("onViewReleased 2");
            } else if (direction < 0 && mSlideOffset >= mAnchorPoint) {
                // swipe down -> collapse and stop at anchor point
//                target = computePanelTopPosition(mAnchorPoint);
                target = computePanelTopPosition(0.0f) + (mIsSlidingUp ? +mPanelHeight : -mPanelHeight);
//                System.out.println("onViewReleased 3");
                LogUtil.trackAction("alliance_sys_channel_hands_up");
            } else if (direction < 0 && mSlideOffset < mAnchorPoint) {
                // swipe down past anchor -> collapse
                target = computePanelTopPosition(0.0f);
//                System.out.println("onViewReleased 4");
...
//                
                target = computePanelTopPosition(0.0f) + (mIsSlidingUp ? +mPanelHeight : -mPanelHeight);
//                System.out.println("onViewReleased 5");
                LogUtil.trackAction("alliance_sys_tip_up");
            } else {
                // settle at the bottom
                target = computePanelTopPosition(0.0f);
//                System.out.println("onViewReleased 6");
            }
