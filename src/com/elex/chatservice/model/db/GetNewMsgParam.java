...
public class GetNewMsgParam
{
	...
	{
		if (chatTableName.equals(ChannelManager.getInstance().getCountryChannel().getChatTable().getTableNameAndCreate()))
		{
			...
			channelType = ChannelManager.getInstance().getCountryChannel().channelType;
				...
				&& chatTableName.equals(ChannelManager.getInstance().getAllianceChannel().getChatTable().getTableNameAndCreate()))
		{
