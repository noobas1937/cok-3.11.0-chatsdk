...
public class DBDefinition
{
	...
	public static final String	CHANNEL_ID_POSTFIX_COUNTRY_SYS	= "@country_sys";
	public static final String	CHANNEL_ID_POSTFIX_ALLIANCE	= "@alliance";
	public static final String	CHANNEL_ID_POSTFIX_ALLIANCE_SYS	= "@alliance_sys";
	...
	public static final String	CHANNEL_ID_POSTFIX_DRIFTING_BOTTLE= "@driftingbottle";
	public static final String	CHANNEL_ID_POSTFIX_NEARBY= "@nearby";
	public static final String	CHANNEL_ID_PREFIX_STANDALONG= "standalone@";
	public static final String	CHANNEL_ID_POSTFIX_RANDOM_CHATROOM	= "@randomchatroom";
	...
	public static final int		CHANNEL_TYPE_ALLIANCE_SYS	= 8;
	public static final int		CHANNEL_TYPE_RANDOM_CHAT	= 9;
	public static final int		CHANNEL_TYPE_COUNTRY_SYS	= 10;
	...
	public static String getPostfixForType(int type)
	{
		switch (type)
		{
			...
			case CHANNEL_TYPE_COUNTRY_SYS:
				return CHANNEL_ID_POSTFIX_COUNTRY_SYS;
			case CHANNEL_TYPE_ALLIANCE:
				return CHANNEL_ID_POSTFIX_ALLIANCE;
			case CHANNEL_TYPE_ALLIANCE_SYS:
				return CHANNEL_ID_POSTFIX_ALLIANCE_SYS;
			...
			case CHANNEL_TYPE_RANDOM_CHAT:
				return CHANNEL_ID_POSTFIX_RANDOM_CHATROOM;
			default:
				return null;
		}
	}
	...
	public static final String  USER_COLUMN_CHAT_BG_ID			= "ChatBgId";
	public static final String  USER_COLUMN_CHAT_BG_END_TIME	= "ChatBgEndTime";
	public static final String  USER_COLUMN_CHAT_BG_TEXT_COLOR	= "ChatBgTextColor";
	/**
	 * 官职
	 */
	public static final String	USER_COLUMN_OFFICER				= "Officer";
	
	public static final String	USER_COLUMN_FLAGCOUNTRY			= "FlagCountry";
	
	public static final String	USER_COLUMN_SHOWBANNER			= "ShowBanner";
	...
	public static final String	CREATE_TABEL_USER				= "CREATE TABLE IF NOT EXISTS " + TABEL_USER + "(" + BaseColumns._ID
																		...
																		+ " INTEGER DEFAULT 0 , " + USER_COLUMN_CHAT_BG_ID
																		+ " INTEGER DEFAULT 0 , " + USER_COLUMN_CHAT_BG_END_TIME
																		+ " INTEGER DEFAULT 0 , " + USER_COLUMN_CHAT_BG_TEXT_COLOR
																		+ " TEXT ," + USER_COLUMN_LANG 
																		+ " TEXT ," + USER_COLUMN_FLAGCOUNTRY 
																		+ " TEXT ," + USER_COLUMN_SHOWBANNER
																		+ " INTEGER DEFAULT 0 , "+ USER_COLUMN_OFFICER + " TEXT )";
	...
	/** at玩家的uid */
	public static final String	CHAT_COLUMN_AT_UIDS				= "AtUids";
	/** at是否被看过 */
	public static final String	CHAT_COLUMN_AT_READ_STATUS		= "AtReadStatus";
	...
	public static final String	CREATE_TABLE_CHAT				= "CREATE TABLE IF NOT EXISTS " + CHAT_TABLE_NAME_PLACEHOLDER + "("
																		...
																		+ CHAT_COLUMN_AT_UIDS + " TEXT , " 
																		+ CHAT_COLUMN_AT_READ_STATUS + " INTEGER DEFAULT 0 )";
