...
public class MailNewUI
{
	...
	private MailNewUI()
	{
		...
		newUIMap.put("CHANNEL_ICON_DRIFTING_BOTTLE", "mail_list_main_icon_bottle");
		newUIMap.put("CHANNEL_ICON_NEARBY", "mail_list_main_icon_bottle");
		...
		newUIMap.put("CHANNEL_ICON_RECYCLEBIN", "mail_list_main_icon_recycler");
		newUIMap.put("CHANNEL_ICON_NEW_WORLD_BOSS", "mail_list_main_icon_newworldboss");
		newUIMap.put("CHANNEL_ICON_DRAGON_TOWER", "mail_list_main_icon_dragon_tower");
