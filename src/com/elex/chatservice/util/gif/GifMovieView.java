package com.elex.chatservice.util.gif;
 ...
 * 切换gif时，内存占用很平稳，没有泄露
 * 频繁切换没有发生异常
 * 播放速度较快（可能与机能有关系，2.3.6的机器上速度正常）
 * 
 * 使用了系统库，据说针对不同gif在不同os下不稳定，低版本机器支持可能有问题
 * 在2.3.6上没问题
 * 
 * 使用了attr配置，已注释
 * 
...
//		}
	...
	private void updateAnimationTime() {
		...
		mCurrentAnimationTime = (int) (((now - mMovieStart) / 2) % dur);
	}
