...
public class FooterLoadingLayout extends LoadingLayout
{
	...
	private static String	pull_to_refresh_hint_loading	= "";
	private static int		pull_to_refresh_hint_loading_color = 0x00000000;

	public static void setLanguage(String loading)
	{
		pull_to_refresh_hint_loading = loading;
	}
	
	public static void setLoadingColor(int color)
	{
		pull_to_refresh_hint_loading_color = color;
	}

	protected void setTextColor(int corlor)
	{
		mHintView.setTextColor(corlor);
	}
	...
	protected void onReset()
	{
		if(mHintView!=null)
		{
			mHintView.setText(pull_to_refresh_hint_loading);
			if(pull_to_refresh_hint_loading_color!=0x00000000)
				mHintView.setTextColor(pull_to_refresh_hint_loading_color);
		}
	}
