...
public class PullToRefreshListView extends PullToRefreshBase<ListView> implements OnScrollListener {
    ...
    public void showLoadMoreFooterLayout()
    {
    	if (null != mLoadMoreFooterLayout) {
            mLoadMoreFooterLayout.show(true);
        }
    ...
    public void showFooterLayout(boolean isVisible)
    {
    	if(mLoadMoreFooterLayout!=null)
    		mLoadMoreFooterLayout.show(isVisible);
    }
    
    public void setLoadTextCorlor(int color)
    {
    	FooterLoadingLayout.setLoadingColor(color);
    }
