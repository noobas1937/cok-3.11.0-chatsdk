...
public class SimpleSearchView extends LinearLayout
{
	...
	protected void onFinishInflate()
	{
		...
		this.searchQuery = ((EditText) findViewById(ResUtil.getId(this.mContext, "id", "gs__search_query")));
		this.searchButton = ((ImageButton) findViewById(ResUtil.getId(this.mContext, "id", "gs__search_button")));
		this.clearButton = ((ImageButton) findViewById(ResUtil.getId(this.mContext, "id", "gs__search_query_clear")));
