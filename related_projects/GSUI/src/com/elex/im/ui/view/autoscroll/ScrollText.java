...
public class ScrollText extends TextView implements Runnable
{
	...
	public void scrollNext()
	{
		...
		Msg msgItem = ScrollTextManager.getInstance().getNextText(channelType);
...
//					currentText = StringUtils.isNotEmpty(msgStr) ? msgStr :LanguageManager.getLangByKey(LanguageKeys.MSG_VERSION_NO_SUPPORT);
				}
				else
				{
