...
import com.elex.im.core.model.ChannelListItem;
...
//				break;
	...
	public <T> void sortByRecycleTime(List<T> target, Class<T> type)
	{
		List<ChannelListItem> sortedList = new ArrayList<ChannelListItem>();
		...
		Collections.sort(sortedList, new SortByRecycleTime());
...
//	}
	...
	private class SortByRecycleTime implements Comparator<ChannelListItem>
	{
		@Override
		public int compare(ChannelListItem o1, ChannelListItem o2)
		{
			if (o1.getRecycleTime() < o2.getRecycleTime())
			{
				return 1;
			}
			else if (o1.getRecycleTime() == o2.getRecycleTime())
			{
				return 0;
			}
