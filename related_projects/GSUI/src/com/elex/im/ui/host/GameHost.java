...
public class GameHost implements IHost
{
	 ...
	 * 发送群聊消息
	 */
	public native void sendChatRoomMsg(String groupId, String msg, String sendLocalTime,boolean isMedia);
	...
	public native void deleteAllianceShare(String id,String allianceId,String fid,String fsender,int type);
