...
//		ServiceInterface.onJoinAnnounceInvitationSuccess();
	...
	@Override
	public void sendChatRoomMsg(String groupId, String msg, String sendLocalTime,boolean isMedia)
	{
	}
	...
	@Override
	public void deleteAllianceShare(String id, String allianceId, String fid, String fsender, int type)
	{
	}
