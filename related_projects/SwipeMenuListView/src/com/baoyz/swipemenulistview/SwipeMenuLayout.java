...
public class SwipeMenuLayout extends FrameLayout {
	...
	private int mSwipeDirection = SwipeMenuListView.DIRECTION_LEFT;
	...
	public void swipe(int dis) {
		...
		System.out.println("swipe dis1:"+dis+"  mSwipeDirection:"+mSwipeDirection);
		if(!mSwipEnable){
			return ;
		}
		...
		System.out.println("swipe dis2:"+dis);
