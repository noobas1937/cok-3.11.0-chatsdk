...
public class GSWrapperActivity extends Activity {
	private static final String	ACTIVITY_TAG	= "GSWrapperActivity";
...
//		Firebase.setAndroidContext(getApplicationContext());
		...
		final GSWrapperActivity context = this;
...
//		msgs[2].createTime = TimeManager.getInstance().getCurrentTime() - 24*60*60 + 60;
	...
	protected void showChatFragment() {
		UIManager.showChatActivity(GSWrapperActivity.this, DBDefinition.CHANNEL_TYPE_COUNTRY, false);
	}
...
//    	channel.sendMsg("test message", false, false, null);
	...
	protected void showMailFragment() {
		UIManager.showChatActivity(GSWrapperActivity.this, DBDefinition.CHANNEL_TYPE_USER, false);
	}

	protected void showMemberSelectorFragment() {
		GSController.isCreateChatRoom = true;
		UIManager.showMemberSelectorActivity(GSWrapperActivity.this, true);
	}

	protected void showChatRoomSetting() {
    	GSController.setMailInfo("146673000001", "", "123", 1);
    	UIManager.showChatRoomSettingActivity(GSWrapperActivity.this);
	}
}
