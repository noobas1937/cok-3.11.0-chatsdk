...
import com.elex.chatservice.danmu.model.Duration;
import com.elex.chatservice.danmu.model.FBDanmaku;
import com.elex.chatservice.danmu.model.FTDanmaku;
...
import com.elex.chatservice.danmu.model.L2RDanmaku;
import com.elex.chatservice.danmu.model.R2LDanmaku;
import com.elex.chatservice.danmu.model.SpecialDanmaku;
import com.elex.chatservice.danmu.model.SpecialDanmaku.LinePath;
...
public class DanmakuFactory {
    ...
    public BaseDanmaku createDanmaku(int type, float viewportWidth, float viewportHeight,
        ...
        BaseDanmaku instance = new R2LDanmaku(MAX_Duration_Scroll_Danmaku);
//        switch (type) {
//            case 1: // 从右往左滚动
